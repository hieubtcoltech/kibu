...
(function () {
    ...
    var PAIRS = [
        ...
        /* ---------- Bounce Hoops (bounce-hoops) ---------- */
        ['Ném Bóng Vào Rổ', 'Bounce Hoops'],
        ['Tìm cách cho quả bóng rơi vào rổ nhé!', 'Find a way to drop the ball into the hoop!'],
        ['Kéo để ngắm', 'Drag to aim'],
        ['Kéo lùi lại từ quả bóng. Hàng chấm cho biết bóng sẽ bay đường nào.',
            'Pull back from the ball. The dots show where it will fly.'],
        ['Nảy vào tường', 'Bounce off walls'],
        ['Bàn nhún cam hất bóng lên cao. Gai xanh thì làm hỏng lượt ném.',
            'Orange pads throw the ball high. Green spikes pop it.'],
        ['Thả bóng vào rổ', 'Drop it in'],
        ['Bóng phải rơi từ trên xuống mới vào được rổ.',
            'The ball has to fall into the hoop from above.'],
        ['Không tính giờ, không giới hạn lượt. Bé ném bao nhiêu lần cũng được — ném ít lần thì được nhiều sao hơn thôi.',
        ...
        ['Qua Bức Tường', 'Over The Wall'],
        ['Ném cao lên cho qua khỏi bức tường.', 'Throw high to clear the wall.'],
        ['Chui Dưới Mái', 'Under The Roof'],
        ['Ném thẳng và thấp thì lọt dưới mái.', 'A flat throw fits under the roof.'],
        ['Rời Bệ Đá', 'Off The Ledge'],
        ['Vượt qua cây cột cao rồi thả xuống.', 'Over the tall pillar, then down.'],
        ['Khe Hẹp', 'The Gap'],
        ['Lách quả bóng qua khe hẹp.', 'Squeeze the ball through the gap.'],
        ['Hai Bức Tường', 'Two Walls'],
        ['Qua bức thứ nhất, chui dưới bức thứ hai.', 'Over the first, under the second.'],
        ['Bàn Nhún', 'Springboard'],
        ['Bàn nhún màu cam hất quả bóng lên cao.', 'The orange pad throws the ball high.'],
        ['Nhún Hai Lần', 'Double Bounce'],
        ['Dùng cả hai bàn nhún để trèo lên.', 'Use both pads to climb.'],
        ['Rơi Dưới Trần', 'Ceiling Drop'],
        ['Phải rơi xuống dưới mái rồi mới đi ngang được.', 'Fall below the roof before you cross.'],
        ['Đường Zíc Zắc', 'Zigzag'],
        ['Rơi xuống bệ rồi lăn ra khỏi mép.', 'Land on the shelf, then roll off the end.'],
        ['Cái Giếng', 'The Well'],
        ['Thả quả bóng thẳng xuống giếng.', 'Drop the ball straight down the well.'],
        ['Bóng Nảy Loạn', 'Pinball'],
        ['Cứ để bóng nảy lung tung giữa các bệ.', 'Let it rattle around the shelves.'],
        ['Tường Biết Chạy', 'Moving Wall'],
        ['Chờ bức tường trượt đi chỗ khác.', 'Wait for the wall to slide away.'],
        ['Mái Trượt', 'Sliding Roof'],
        ['Mái cứ trượt qua trượt lại. Canh cho đúng lúc.', 'The roof keeps moving. Time it.'],
        ['Lối Gai', 'Spike Alley'],
        ['Tránh xa mấy bụi gai xanh ra nhé.', 'Keep away from the green spikes.'],
        ['Thoát Hiểm', 'Narrow Escape'],
        ['Chỉ một khe hở, lại còn có khối chắn.', 'One gap, and a block guarding it.'],
        ['Cổng Nhún', 'Bounce Gate'],
        ['Nhún lên cao rồi lách qua cổng.', 'Pad up, then through the gate.'],
        ['Đường Hầm', 'The Tunnel'],
        ['Bay thật thẳng qua đường hầm.', 'Fly flat through the tunnel.'],
        ['Trèo Lên Cao', 'High Climb'],
        ['Trèo qua từng bệ đá lên tới bệ trên cùng.', 'Climb the ledges to the top shelf.'],
        ['Hai Làn Đạn', 'Crossfire'],
        ['Hai khối biết chạy, chỉ một ô cửa.', 'Two movers, one window.'],
        ['Cầu Gai', 'Spike Bridge'],
        ['Bay trên bụi gai hoặc chui dưới cây cầu.', 'Over the spikes or under the bridge.'],
        ['Lên Mái Nhà', 'Rooftop'],
        ['Lên tới mái, lách qua khối treo lơ lửng.', 'Up to the roof, past the hanging block.'],
        ['Ném Dội Tường', 'Bank Shot'],
        ...
        ['Người Nhện Leo Tháp', 'Spider Climb'],
        ['NGƯỜI NHỆN LEO THÁP', 'SPIDER CLIMB'],
        ['Hai toà tháp, một đường leo không có đích. <b>Chạm để bay</b> sang tường bên kia, <b>bắn tơ</b> vào bất cứ thứ gì chắn đường, rồi xem thành phố cho mình lên tới đâu.',
            'Two towers, one endless climb. <b>Tap to leap</b> to the other wall, <b>fire your web</b> at whatever is in the way, and see how high the city lets you get.'],
        ['BẮT ĐẦU LEO', 'START CLIMBING'],
        ['LEO TIẾP', 'KEEP CLIMBING'],
        ['LEO LẠI', 'CLIMB AGAIN'],
        ['HẾT LƯỢT RỒI', 'RUN OVER'],
        ['Thành phố đợi con mà.', 'The city will wait for you.'],

        /* sáu vùng cao độ — dùng chung cho dải ở màn chào, dải báo vùng mới,
           và dòng "đã tới" ở màn kết thúc */
        ['Phố Buổi Sớm', 'Street Morning'],
        ...
        /* ---------- Bé Tập Lái Máy Bay ---------- */
        ['Bé Tập Lái Máy Bay', 'Flight Adventure Kids'],
        ['BÉ TẬP LÁI MÁY BAY', 'FLIGHT ADVENTURE KIDS'],
        ['BÉ TẬP LÁI', 'FLIGHT ADVENTURE'],
        ['Lái một chiếc máy bay hiền lành, ngắm thế giới phía dưới, chụp ảnh những nơi nổi tiếng, rồi hạ cánh an toàn. Con không bao giờ bị rơi.',
            'Fly a friendly airplane, look at the world below, take photos of famous places, and land safely. You can never crash.'],

        /* nút và màn hình */
        ['BAY NGAY', 'FLY NOW'],
        ['SỔ DU LỊCH', 'TRAVEL ALBUM'],
        ['SỔ LƯU', 'ALBUM'],
        ['BAY TIẾP', 'FLY AGAIN'],
        ['BAY TIẾP NÀO', 'KEEP FLYING'],
        ['TẠM DỪNG', 'PAUSED'],
        ['CON HIỂU RỒI', 'GOT IT'],
        ['QUAY LẠI', 'BACK'],
        ['CÁCH LÁI MÁY BAY', 'HOW TO FLY'],
        ['Chuyến bay', 'Flights'],
        ['Ngôi sao', 'Stars'],
        ['Con dấu sân bay', 'Airport stamps'],
        ['Ảnh thắng cảnh', 'Landmark photos'],
        ['Chụp ảnh', 'Take a photo'],
        ['Bay giúp con', 'Auto-help'],
        ['Giúp con hạ cánh', 'Help me land'],
        ...
        ['{0} hoặc phím mũi tên cho máy bay lên xuống.',
            '{0} or the arrow keys make the plane go up and down.'],
        ['Bay xuyên qua {0} và nhặt {1}.', 'Fly through the {0} and collect {1}.'],
        ['vòng sáng', 'glowing rings'],
        ['ngôi sao', 'stars'],
        ['Thấy một nơi nổi tiếng thì bấm {0} để chụp ảnh.',
            'When a famous place appears, press {0} to take a photo.'],
        ['Gần tới nơi thì bấm {0}, trò chơi sẽ giúp con hạ cánh.',
            'Near the end, press {0} and the game helps you land.'],
        ['Bấm {0} lúc nào cũng được, máy bay sẽ tự bay.',
            'Press {0} any time and the plane flies by itself.'],
        ['Con không bao giờ bị rơi. Bay thấp quá thì trò chơi sẽ nâng con lên.',
        ...
        ['Mình lượn một vòng rồi thử lại đường băng nhé!', 'Let us circle around and try the runway again!'],
        ['Lần này mình hạ cánh cùng nhau nhé. Giữ chặt nào!', 'Let us land together this time. Hold on!'],
        ['Giỏi quá! Mình đã ở trên đường băng rồi.', 'Great! We are on the runway.'],
        ['Đã bật chế độ bay giúp. Ngắm cảnh thôi nào!', 'Auto-help is on. Enjoy the view!'],
        ['Con lái tiếp nhé!', 'You are flying again!'],
        ['Đã bật trợ giúp hạ cánh. Giữ chặt nào!', 'Landing help is on. Hold on!'],
        ['Nhìn kìa, một nơi nổi tiếng! Chụp ảnh đi!', 'Look, a landmark! Take a photo!'],

        /* hạng hạ cánh */
        ['Hạ Cánh Tuyệt Vời', 'Great Landing'],
        ['Hạ Cánh Tốt', 'Nice Landing'],
        ['Hạ Cánh Có Trợ Giúp', 'Assisted Landing'],
        ['Lần này chưa chụp được ảnh nào. Chuyến sau thử nút máy ảnh nhé!',
            'No photos this time. Try the camera button next flight!'],
        ['Hạ cánh xuống một sân bay để có con dấu đầu tiên nhé!',
            'Land at an airport to earn your first stamp!'],
        ['Sổ lưu còn trống. Vừa bay vừa chụp ảnh nhé!',
            'Your album is empty. Take a photo while you fly!'],

        /* thắng cảnh và sân bay trên tuyến */
        ['Hồ Hoàn Kiếm', 'Hoan Kiem Lake'],
        ['Một cái hồ nổi tiếng ở giữa Hà Nội.', 'A famous lake in the middle of Hanoi.'],
        ['Dòng Sông Uốn Khúc', 'Winding River'],
        ['Sông mang nước từ núi ra tới biển.', 'Rivers carry water from the mountains to the sea.'],
        ['Đèo Hải Vân', 'Hai Van Pass'],
        ['Một con đèo chạy cao trên mặt biển.', 'A mountain road high above the sea.'],
        ['Biển Mỹ Khê', 'My Khe Beach'],
        ['Một bãi cát dài ngay cạnh thành phố.', 'A long sandy beach beside the city.'],
        ['Cầu Rồng', 'Dragon Bridge'],
        ['Một cây cầu mang hình con rồng.', 'A bridge shaped like a dragon.'],
        ['Hà Nội', 'Hanoi'],
        ['Đà Nẵng', 'Da Nang'],
        ...
        ['Bảng chọn', 'Menu'],
        ['BẢNG CHỌN', 'MENU'],
        ['NHIỆM VỤ HÔM NAY', "TODAY'S MISSIONS"],
        ['KỶ LỤC CỦA CON', 'YOUR RECORDS'],
        ['Chuỗi liên hoàn dài nhất', 'Longest combo'],
        ['Đã hạ bao nhiêu máy bay', 'Drones webbed'],
        ...
        ['ĐANG MẶC', 'WEARING'],
        ['MẶC', 'WEAR'],
        ['Không đủ xu', 'Not enough coins'],
        ['Mở được rồi!', 'Unlocked!'],
        ['Bám lại được rồi!', 'Back on the wall!'],

        /* tên các bộ đồ */
        ['Đỏ Cổ Điển', 'Classic Red'],
        ['Xanh Nửa Đêm', 'Midnight Blue'],
        ['Xanh Neon', 'Neon Green'],
        ...
        /* khuôn nhiệm vụ — {0} là con số, nên mười sáu dòng này đủ cho cả 33
           nhiệm vụ, khỏi phải dịch từng cái một */
        ['Leo tới {0} m', 'Climb to {0} m'],
        ['Nhặt {0} đồng xu trong một lượt', 'Collect {0} coins in one climb'],
        ['Bắn rơi {0} máy bay không người lái', 'Web {0} drones out of the sky'],
        ['Bắn hạ {0} kẻ cản đường', 'Web {0} of the climbers who get in your way'],
        ['Vượt qua {0} đợt gió', 'Ride out {0} wind gusts'],
        ['Nhảy qua lại giữa hai tháp {0} lần', 'Jump between the towers {0} times'],
        ['Nối được chuỗi {0} lần liên tiếp', 'Chain a combo of {0}'],
        ['Né sát {0} lần', 'Slip past {0} near misses'],
        ['Nhặt {0} viên ngọc', 'Pick up {0} gems'],
        ['Bám lại tường {0} lần sau khi rơi', 'Catch a wall {0} times after a fall'],
        ['Nhặt {0} món tăng sức', 'Grab {0} power-ups'],
        ['Làm vỡ {0} tấm tường nứt', 'Break {0} cracked panels'],
        ['Bắn {0} phát tơ', 'Fire {0} web shots'],
        ...
        ['NAM CHÂM', 'MAGNET', 'x'],
        ['CHẬM', 'SLOW', 'x'],
        ['Con rơi mất rồi!', 'You fell!'],
        ['Coi chừng!', 'Careful!'],
        ['Trúng rồi!', 'Hit!'],
        ['Mảnh vỡ rơi!', 'Falling debris!'],
        ['Tia laser!', 'Laser!'],

        /* cách chơi */
        ['<b>Con tự leo lên</b> khi đang bám tường. Việc ấy không bao giờ dừng.',
            '<b>You climb by yourself</b> while you hang on a wall. That never stops.'],
        ['<b>Chạm vào đâu cũng được</b> để bay sang tháp bên kia. Canh nhảy trước khi tường phía trên bị chặn.',
            '<b>Tap anywhere</b> to leap across to the other tower. Time it before the wall ahead is blocked.'],
        ['<b>Đang rơi?</b> Chạm thêm một cái để bắn tơ bám lại vào tường — mỗi lần bám tốn một phát tơ. Rơi khỏi đáy màn là mất một mạng.',
            '<b>Falling?</b> Tap again to shoot a web line and catch the wall - each catch costs one web shot. Fall off the bottom and it costs a life.'],
        ['<b>Bấm nút TƠ</b> để hạ máy bay, chim và mấy thứ long ra. Vòng tròn nét đứt cho biết sắp bắn trúng cái gì.',
            '<b>Tap the WEB button</b> to shoot down drones, birds and loose gear. The dashed ring shows what you will hit.'],
        ['Vào <b>Đêm Giông</b>, sét sẽ nhắm đúng chỗ con SẮP tới và loé sáng ở đó một nhịp. Nhảy đi hoặc leo vọt lên cho lệch chỗ — cứ leo đều như cũ là bị hất văng khỏi tường.',
            'In the <b>Night Storm</b> a bolt will pick out where you are heading and glow there for a moment. Jump or climb fast to be somewhere else - stay on course and it knocks you clean off the wall.'],
        ['Kính bám vẫn chắc, nhưng vạch sọc ở mép trên ô kính là hạn chót — phải nhảy đi trước khi bò tới đó, không thì cả tấm vỡ. Tấm nứt thì ngược lại: bám lâu mới vỡ, nên ở đó phải leo thật nhanh. Dây điện giật, nhưng tơ cắt đứt được.',
            'Glass holds you fine, but the striped band at the top of the pane is a deadline - leap off before you reach it or the whole pane shatters. Cracked panels break if you linger, so there you climb fast instead. Live cables shock, but your web cuts them.'],
        ...
        ['THÁP KHỐI', 'BLOCK TOWER'],
        ['Một cái giếng đầy <b>khối màu rực rỡ</b> lơ lửng giữa phòng. Xếp cho kín từng hàng — và nhặt lấy <b>khối vàng</b>, nó đáng gấp ba.',
            'A well of <b>bright colour blocks</b> floating in mid-air. Stack them into full rows - and grab the <b>gold blocks</b>, they are worth triple.'],
        ['BẮT ĐẦU XẾP', 'START STACKING'],
        ['XẾP TIẾP', 'KEEP STACKING'],
        ['ĐẦY GIẾNG RỒI!', 'TOWER FULL!'],
        ['Điểm', 'Score', 'x'],
        ['Số hàng đã phá', 'Rows cleared'],
        ['Bàn đã tới', 'Level reached'],
        ['Tạm nghỉ', 'Pause'],
        ['ĐANG TẠM DỪNG', 'PAUSED'],
        ['Nghỉ một lát cũng được, cái tháp đợi con mà.', 'Take a break, the tower will wait.'],
        ['đỏ', 'ruby'],
        ['xanh biển', 'azure'],
        ['xanh lá', 'lime'],
        ['tím ×2', 'violet ×2'],
        ...
        ['Gác xép', 'The Attic'],
        ['Ban công đêm', 'Night Balcony'],
        ['Hầm vàng', 'The Vault'],
        ['ĐIỂM', 'SCORE'],
        ['HÀNG', 'LINES'],
        ['BÀN', 'LEVEL'],
        ['TIẾP', 'NEXT'],
        ['<b>Chạm nửa trái hoặc nửa phải</b> màn hình để đẩy khối sang. <b>Chạm giữa</b> để xoay khối.',
            '<b>Tap the left or right side</b> of the screen to slide the block. <b>Tap the middle</b> to turn it.'],
        ['<b>Vuốt xuống</b> là khối rơi thẳng xuống ngay.',
            '<b>Swipe down</b> to drop it straight away.'],
        ['Chơi bằng bàn phím: mũi tên để đi và xoay, phím cách để thả, phím P để tạm dừng.',
            'On a keyboard: arrow keys to move and turn, space to drop, P to pause.'],
        ['Lấp kín một hàng là nó vỡ tung. Phá bốn hàng một lúc đáng hơn hẳn phá từng hàng một.',
        ...
        ['Bắn Vịt', 'Duck Shoot'],
        ['BẮN VỊT', 'DUCK SHOOT'],
        ['<b>1 tới 4 bé</b> trên cùng một màn hình. Mỗi bé giữ một khoảnh trời — bắn trượt là con vịt trôi sang chỗ bạn!',
            '<b>1 to 4 kids</b> on one screen. Each kid guards one slice of the sky — miss a duck and it drifts over to your friend!'],
        ['SỐ NGƯỜI CHƠI', 'NUMBER OF PLAYERS'],
        ['BẮT ĐẦU THI TÀI', 'START THE CONTEST'],
        ['Điểm cao nhất:', 'Best score:'],
        ['Xoay ngang điện thoại để bầu trời rộng hơn nhiều.', 'Turn your phone sideways for a much bigger sky.'],
        ['KỶ LỤC MỚI!', 'NEW BEST!'],
        ['CÁCH CHƠI', 'HOW TO PLAY'],
        ['QUAY LẠI', 'BACK'],
        ['CHƠI LẠI', 'PLAY AGAIN'],
        ['ĐỔI SỐ NGƯỜI', 'CHANGE PLAYERS'],
        ['Cách chơi', 'How to play'],
        ['Âm thanh', 'Sound'],
        ['Đổi số người', 'Change players'],
        ['<b>Chạm vào khoảnh trời của mình</b> để bắn. Bé chỉ hạ được con vịt đang bay trong phần của mình.',
            '<b>Tap your own slice of the sky</b> to shoot. You can only hit ducks flying inside your slice.'],
        ['Chơi bằng bàn phím thì mỗi bé một phím — phím bắn vào con vịt gần giữa khoảnh trời của bé nhất.',
            'On a keyboard each kid has one key — the key shoots at the duck nearest the middle of your slice.'],
        ['🦆 vịt to <b>1 điểm</b> · 🐤 vịt nhỏ bay nhanh <b>2 điểm</b> · 🥇 vịt vàng <b>5 điểm</b>.',
            '🦆 big duck <b>1 point</b> · 🐤 small fast duck <b>2 points</b> · 🥇 golden duck <b>5 points</b>.'],
        ['Coi chừng — <b>con chim đen ức đỏ không phải vịt</b>. Bắn nhầm là mất 3 điểm. Cứ để nó bay qua!',
            'Watch out — <b>dark birds with a red chest are not ducks</b>. Shoot one and you lose 3 points. Let them fly past!'],
        ['nhầm ', 'oops ', 'x'],
        ...
        ['🕊️ Đàn vịt', '🕊️ Flock'],
        ['🥇 Vòng vàng', '🥇 Golden'],
        /* Bốn cặp rời chứ không dùng {0}: chỗ giữ chỗ khớp với bất kỳ chuỗi ký
         * tự nào, mà "{0} thắng!" thì bắt luôn cả những câu khác trong trang. */
        ['BÉ 1 thắng!', 'KID 1 wins!'],
        ['BÉ 2 thắng!', 'KID 2 wins!'],
        ['BÉ 3 thắng!', 'KID 3 wins!'],
        ['BÉ 4 thắng!', 'KID 4 wins!'],
        ['Hoà nhau rồi!', "It's a tie!"],
        /* Tên bé và tên vòng do game.js dựng ra lúc chạy. Chúng đã đúng thứ
         * tiếng ngay từ đầu, nhưng vẫn phải có cặp ở đây: bé đổi cờ giữa ván
         * thì bảng điểm và huy hiệu vòng phải đổi theo, không thì nửa màn hình
         * tiếng Việt nửa màn hình tiếng Anh. */
        ['BÉ 1', 'KID 1'],
        ['BÉ 2', 'KID 2'],
        ['BÉ 3', 'KID 3'],
        ['BÉ 4', 'KID 4'],
        ['VÒNG', 'ROUND'],
        ['HẾT VÒNG', 'ROUND OVER'],
        ['Bình minh đồng cỏ', 'Dawn Meadow'],
        ['Hoàng hôn mặt hồ', 'Sunset Lake'],
        ['Đêm đom đóm', 'Firefly Night'],
        ['Trời nổi bão', 'Storm Front'],
        ['Đàn vịt kéo về', 'The Big Flock'],
        ['Vòng vàng', 'Golden Round'],
        ['Vịt bay thẳng và chậm — quen tay đã.', 'Ducks fly straight and slow. Warm up.'],
        ['Vịt lượn lên xuống như sóng.', 'Ducks ride the wind up and down.'],
        ['Trời tối. Chỉ thấy vịt khi nó lướt qua vệt trăng.', 'Dark out. You only see ducks in the moonbeams.'],
        ['Gió giật từng cơn, vịt chao đảo.', 'Gusts throw the ducks off course.'],
        ['Cả đàn kéo về một lúc. Bắn nhanh tay!', 'The whole flock at once. Fire fast!'],
        ['Vịt vàng bay rất nhanh, điểm gấp ba.', 'Golden ducks, fast and worth triple.'],

        /* ---------- Marble Machine (marble-machine) ---------- */
        ['Cỗ Máy Kỳ Quặc', 'Marble Machine'],
        ['CỖ MÁY KỲ QUẶC', 'MARBLE MACHINE'],
        ['Cỗ máy rơi mất mấy mảnh. Lắp lại rồi thả cho viên bi chạy nào!',
            'The contraption lost a few pieces. Put them back and let the marble roll!'],
        ['Lấp chỗ trống', 'Fill the gaps'],
        ['Kéo mảnh từ khay vào ô có viền đứt. Chạm vào mảnh là nó quay ngược chiều.',
            'Drag a piece from the tray into a dashed slot. Tap it to turn it around.'],
        ['Bấm CHẠY', 'Press RUN'],
        ['Viên bi thả xuống, cả dây chuyền chạy một lượt liền mạch.',
            'The marble drops in and the whole chain reaction goes off at once.'],
        ['Rơi trúng giỏ', 'Land in the basket'],
        ['Trượt à? Nhìn xem bi đi lạc chỗ nào, đổi mảnh rồi chạy lại.',
            'Miss it? Watch where the marble went wrong, swap a piece and run again.'],
        ['Màn nào cũng được dựng thành một cỗ máy chạy được TRƯỚC rồi mới tháo mảnh ra làm đề bài, nên màn nào cũng chắc chắn lắp lại được — không bế tắc, không phải mua gì.',
            'Every level is built as a working machine first and only then taken apart, so every single one really can be rebuilt - no dead ends, nothing to buy.'],
        ['Màn', 'Level'],
        ['Còn mảnh', 'Pieces left'],
        ['CHẠY', 'RUN'],
        ['Cách chơi', 'How to play'],
        ...
        ['CHẠY ĐƯỢC RỒI!', 'IT WORKS!'],
        ['Chạy thử mấy lượt', 'Runs used'],
        ['MÀN TIẾP THEO', 'NEXT LEVEL'],
        ['CÁC MẢNH MÁY', 'THE PIECES'],
        ['Dốc trượt', 'Ramp'],
        ['Một cái máng. Viên bi lăn xuống theo nó.', 'A slide. The marble rolls down it.'],
        ['Bập bênh', 'Seesaw'],
        ['Sức nặng viên bi lật ván xuống, rồi nó lăn theo mặt ván sang đầu kia.',
            "The marble's weight tips the plank, then it rolls down the other side."],
        ['Bàn nhún', 'Bouncer'],
        ['Tấm đệm có lò xo. Viên bi bật lên vượt qua bức tường.',
            'A springy pad. The marble bounces up and over the wall.'],
        ['Quạt gió', 'Fan'],
        ['Thổi bạt viên bi sang ngang trong lúc nó đang rơi.',
            'Blows the marble sideways while it falls.'],
        ['Băng chuyền', 'Conveyor'],
        ['Chở viên bi chạy đi. Nhìn kỹ chiều mũi tên nhé.',
            'Carries the marble along. Watch the arrows.'],
        ['Đệm nảy', 'Bumper'],
        ['Tròn và nảy — viên bi đập vào là bắn chéo đi.',
            'Springy and round - the marble pings off it.'],
        ['Nam châm', 'Magnet'],
        ['Hút viên bi vượt qua cái khe mà nó không đời nào nhảy nổi.',
            'Pulls the marble across a gap it could never jump.'],
        ['Mảnh nào có chiều thì quay được: thả vào ô rồi chạm vào nó một cái.',
            'Pieces with a direction can be turned around: drop one in a slot, then tap it.'],
        ['Viên bi kẹt mất rồi — thử mảnh khác xem!', 'The marble got stuck - try another piece!'],
        ['Viên bi rơi trượt giỏ mất rồi!', 'The marble missed the basket!'],
        ['Đã hiểu', 'Got it'],

        /* ---------- Claw Machine (claw-machine) ---------- */
        ['Máy Gắp Thú', 'Claw Machine'],
        ['Lái càng, thả xuống, gắp một bạn thú bông về nhà!',
            'Drive the claw, drop it, and grab a cuddly friend!'],
        ['Ngắm cho thẳng', 'Line it up'],
        ['Giữ nút mũi tên cho càng chạy dọc thanh ray.',
            'Hold the arrows to slide the claw along the rail.'],
        ['Thả xuống và quắp', 'Drop and grab'],
        ['Càng hạ xuống, khép lại rồi kéo lên. Bám chắc vào nhé bạn nhỏ!',
            'The claw dives, closes and lifts. Hold on, little one!'],
        ['Xếp đầy tủ thú', 'Fill your shelf'],
        ['Ba mươi bạn thú khác nhau để sưu tầm. Bạn nào gắp được là của bé mãi mãi.',
            '30 different plushies to collect. Yours are kept forever.'],
        ['Máy gắp thú ngoài đời có ăn gian: nhà sản xuất chỉnh lực càng yếu đi, cứ mấy chục lượt mới cho một lượt quắp chặt. Máy này thì không — lực càng là một con số cố định, lượt nào cũng y như lượt nào.',
            'Real claw machines cheat: the maker turns the grip down so the claw only holds tight once every so many tries. This one never does that — the grip is one fixed number, the same on every single go.'],
        ['Lượt của bé', 'Your turn'],
        ['Lượt còn lại', 'Tries left'],
        ['Gắp được', 'Grabbed'],
        ['THẢ', 'DROP'],
        ['Tủ Thú Của Bé', 'My shelf'],
        ['TỦ THÚ CỦA BÉ', 'MY SHELF'],
        ['Đã sưu tầm', 'Collected'],
        ['Dọn sạch tủ', 'Empty the shelf'],
        ['Mẻ lưới ngon lành!', 'Nice haul!'],
        ['Suýt nữa thì được!', 'So close!'],
        ['Kỷ lục mới!', 'New best!'],
        ['Gắp được mấy bạn', 'Plushies grabbed'],
        ['Tủ thú', 'Shelf'],
        ['Được hai bạn một lúc!', 'Two at once!'],
        ['Được một bạn rồi!', 'Got one!'],
        ['Tới lượt bé {0}', "Kid {0}'s turn"],
        ['Hoà nhau rồi!', "It's a tie!"],
        ...
        ['Chạm rồi chạm', 'Tap, then tap'],
        ['Chạm một ống để nhấc lớp màu trên cùng lên, chạm ống kia là rót sang.',
            'Tap a tube to lift the top colour, tap another to pour it in.'],
        ['Màu nào chồng màu nấy', 'Same on same'],
        ['Chỉ rót được lên đúng màu ấy, hoặc rót vào ống còn trống.',
            'Colour only pours onto the same colour, or into an empty tube.'],
        ['Bí thì cứ hỏi', 'Stuck? Just ask'],
        ['Mách nước và lùi lại đều miễn phí, bấm bao nhiêu lần cũng được. Không tính giờ, không mạng.',
            'Hint and Undo are free and unlimited. No timer, no lives.'],
        ['Cả sáu mươi màn đều được máy giải thử trước khi đưa tới đây, nên màn nào cũng chắc chắn xong được. Chơi hai bé thì hai bé nhận đúng một giàn ống giống nhau — ai xong trước là thắng.',
            'All 60 levels were solved by a machine before they got here, so every single one can be finished. With 2 kids you both get the same tubes — first one done wins!'],
        ['Ký hiệu màu: Bật', 'Colour marks: ON'],
        ['Ký hiệu màu: Tắt', 'Colour marks: OFF'],
        ['Mỗi màu còn mang thêm một hình riêng, để bé nào hay lẫn màu vẫn phân biệt được các ống.',
            'Each colour also carries its own little shape, so kids who mix up colours can still tell the tubes apart.'],
        ['Mách Nước', 'Hint'],
        ['Số Nước', 'Moves'],
        ['XONG HẾT RỒI!', 'ALL SORTED!'],
        ['Số nước bé đi', 'Your moves'],
        ['Ít nhất có thể', 'Fewest possible'],
        ['Tốt nhất của bé', 'Your best'],
        ['THI LẠI', 'RACE AGAIN'],
        ['Hai bé cùng một giàn ống, cùng một chỗ bắt đầu — công bằng nhé.',
            'Same tubes, same start — fair and square.'],
        ['Từ đây không đi tiếp được — bé lùi lại thử nhé!', 'No way from here — try Undo!'],
        /* bốn thế giới */
        ['Hồ Nước', 'Splash Pool'],
        ['Phòng Màu', 'Rainbow Lab'],
        ['Chật Chỗ', 'Tight Squeeze'],
        ['Một Ống Trống', 'One Spare Tube'],
        ...
        ['Mục tiêu thi đấu', 'Party goals'],
        ['Hai bé đua mục tiêu mới mỗi ván: quả, điểm, hoặc số lần ghép.',
            'Two kids race for a new goal each round: fruit, score, or merges.'],
        ['Chơi hai bé thì mỗi bé một thùng. Các ván xoay vòng giữa Đua Dưa Hấu, Săn Trái Cây, Đua Điểm và Tiệc Ghép Quả. Thùng bé nào tràn thì bé kia được.',
            'With 2 kids each one gets a basket. Rounds rotate between Watermelon Race, Fruit Hunt, Score Sprint, and Merge Party. If a basket overflows, the other kid takes it.'],
        ['Điều khiển', 'Controls'],
        ['Cảm ứng: kéo rồi nhả tay. Bàn phím: Bé 1 dùng A/D/S, Bé 2 dùng mũi tên/mũi tên xuống.',
            'Touch: slide and release. Keyboard: Kid 1 uses A/D/S, Kid 2 uses arrows/Down.'],
        ['Cảm ứng: kéo sang trái phải, rồi nhả tay để thả quả.',
            'Touch: slide left and right, then let go to drop.'],
        ['Bàn phím: Bé 1 dùng A/D và S. Bé 2 dùng phím mũi tên và mũi tên xuống.',
            'Keyboard: Kid 1 uses A/D and S. Kid 2 uses arrow keys and Down.'],
        ['Đua Dưa Hấu', 'Watermelon Race'],
        ['Săn Trái Cây', 'Fruit Hunt'],
        ['Đua Điểm', 'Score Sprint'],
        ['Tiệc Ghép Quả', 'Merge Party'],
        ['Săn Dứa', 'Pineapple Hunt'],
        ['Đua Đào', 'Peach Dash'],
        ['Xếp Cổ Điển', 'Classic Stack'],
        ['Làm quả to nhất có thể!', 'Make the biggest fruit you can!'],
        ['Ra quả dưa hấu trước là thắng!', 'First watermelon wins!'],
        ['Ra quả dứa trước là thắng!', 'First pineapple wins!'],
        ['Đạt 180 điểm trước là thắng!', 'First to 180 points wins!'],
        ['Ghép 12 lần trước là thắng!', 'First to 12 merges wins!'],
        ['Ra quả đào trước là thắng!', 'First peach wins!'],
        ['Tìm được quả dứa!', 'Pineapple found!'],
        ['Đạt mục tiêu điểm!', 'Score goal reached!'],
        ['Hoàn thành tiệc ghép quả!', 'Merge party complete!'],
        ['Thắng cuộc đua đào!', 'Peach dash won!'],
        ['Mục tiêu', 'Goal'],
        ['điểm', 'pts'],
        ['Ghép', 'Merge'],
        ...
        ['Tay phi tiêu cừ khôi của gian hàng!', 'The sharpest dart thrower at the fair!'],
        ['CHƠI Ở ĐÂU', 'WHERE TO PLAY'],
        ['HỘI CHỢ', 'FAIRGROUND'],
        ['BÃI BIỂN', 'BEACH'],
        ['NGOÀI VŨ TRỤ', 'OUTER SPACE'],
        ['Lặng gió', 'Calm air'],
        ['Có gió! Khó hơn', 'Windy! Harder'],
        ['Ít trọng lực!', 'Low gravity!'],
        ['Kỷ lục cũ: {0} điểm', 'Previous best: {0} points'],
        ['Kỷ lục của con: {0} điểm', 'Your record: {0} points'],
