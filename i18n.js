...
(function () {
    ...
    var PAIRS = [
        ...
        ['Lật Hình Tìm Cặp', 'Flip Frenzy'],
        ['Lật hai lá. Giống nhau không? Của bé đấy - và bé được đi tiếp!',
            'Flip two cards. Same picture? They are yours - and you go again!'],
        ['Ai chơi nào?', 'Who is playing?'],
        ['Bé đấu với máy', 'Me vs the robot'],
        ['2 bé', '2 kids'],
        ['3 bé', '3 kids'],
        ['4 bé', '4 kids'],
        ['Trí nhớ của máy', 'Robot memory'],
        ['Hay quên', 'Forgetful'],
        ['Khá tinh', 'Pretty sharp'],
        ['Không quên gì', 'Never forgets'],
        ['Bao nhiêu lá?', 'How many cards?'],
        ['12 lá', '12 cards'],
        ['16 lá', '16 cards'],
        ['24 lá', '24 cards'],
        ['30 lá', '30 cards'],
        ...
        ['Trái cây', 'Fruit'],
        ['Xe cộ', 'Vehicles'],
        ['Dưới biển', 'Under the sea'],
        ['Mặt ngộ nghĩnh', 'Silly faces'],
        ['Đồng hồ lượt', 'Turn clock'],
        ['Thong thả', 'Relaxed'],
        ['Nhanh tay', 'Speedy'],
        ['Không tính giờ', 'No clock'],
        ['Cặp vàng - ăn hai điểm', 'Golden pair - worth two points'],
        ['Cặp quà - cướp một điểm của bé đang dẫn đầu',
            'Gift pair - steal a point from whoever is winning'],
        ['BẮT ĐẦU', 'START'],
        ['Ván mới', 'New game'],
        ['Chia lại bài', 'Deal again'],
        ['Bé', 'Me'],
        ['Máy', 'Robot'],
        ['Bé {0}', 'Kid {0}'],
        ['CẶP VÀNG! +2', 'GOLDEN PAIR! +2'],
        ['CẶP QUÀ! Cướp được một điểm', 'GIFT PAIR! You stole a point'],
        ['CẶP QUÀ! +1', 'GIFT PAIR! +1'],
        ['CHUỖI x{0}! thưởng thêm 1', 'STREAK x{0}! +1 bonus'],
        ['Hết giờ rồi!', "Time's up!"],
        ['BÉ THẮNG!', 'WINNER!'],
        ['HOÀ RỒI!', "IT'S A TIE!"],
        ['Chơi ván nữa', 'Play again'],
        ['Đổi người chơi', 'Change players'],
