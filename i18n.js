...
(function () {
    ...
    var PAIRS = [
        ...
        ['Chạy Cứu Bạn', 'Rescue Run'],
        ['Chạy, nhảy và cứu các bạn nhỏ. Cứu được ai là bạn ấy chạy ngay sau lưng.',
            'Run, jump and free your friends. They run right behind you.'],
        ['Chạm nửa trên để nhảy', 'Tap up top to jump'],
        ['Giữ tay lâu hơn thì nhảy cao hơn.', 'Hold your finger down to jump higher.'],
        ['Chạm nửa dưới để trượt', 'Tap down low to slide'],
        ['Trượt để chui qua cành thấp.', 'Slide under the low branches.'],
        ['Cứu các bạn nhỏ', 'Free your friends'],
        ['Mỗi bạn cứu được lại nhân thêm điểm cho bé.',
            'Every friend you free doubles down your score.'],
